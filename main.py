...
r = requests.get('http://fundamentus.com.br/fii_resultado.php', headers=headers)
...
# Característica Dos Titulos Imobiliários
...
# Filtra os elementos
cabecalho = ["Código", "Segmento", "Cotação Atual", "Dividend Yield", "Valor de Mercado", "Liquidez"]
...
for elemento in resultado:
    tabela.append([
        ...
        locale.currency(elemento.valor_mercado),
        locale.currency(elemento.liquidez)
    ])
